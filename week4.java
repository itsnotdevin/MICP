...
public class week4 {
    ...
    {
        if (dict == null || word == null) throw new IllegalArgumentException("String or Dictionary were null");
        if (dict.length() < 1 || word.length() < 1) return false;
        String[] parsedDict = dict.split(", ");
